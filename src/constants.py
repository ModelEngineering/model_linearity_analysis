...
COL_MODEL = "model"
COL_ENTIME_SOURCE = "end_time_source"  # How end_time was determined (e.g. "reciprocal_min_eigenvalue", "default")
...
COLUMNS = [COL_MODEL, COL_MAXCV, COL_ENDTIME, COL_ENTIME_SOURCE]